...
def esGanador(tablero, jugador):
    ...
    return ((b['1'] == b['2'] == b['3'] == b['4'] == p) or  # Horizontal arriba
            (b['6'] == b['6'] == b['7'] == b['8'] == p) or  # Horizontal mitad 1
            (b['9'] == b['10'] == b['11'] == b['12'] == p) or  # Horizontal mitad 2
            (b['3'] == b['14'] == b['15'] == b['16'] == p) or  # Horizontal abajo
            (b['1'] == b['5'] == b['9'] == b['13'] == p) or  # Vertical izquierda
            (b['2'] == b['6'] == b['10'] == b['14'] == p) or  # Vertical centro1
            (b['3'] == b['7'] == b['11'] == b['15'] == p) or  # Vertical centro2
